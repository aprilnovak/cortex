...
# USER INPUTS
# -----------------------------
STEP_PATH = r"C:\Users\tpaga\OneDrive\Desktop\UIUC\EUDEMO.stp"
export_folder = r"C:\Users\tpaga\OneDrive\Desktop\UIUC"
...
OB_OFFSETS_CM = [-8.0, -18.0, -28.0, -38.0, -48.0, -58.0, -78.0] # equatorial limit is 95-100 cm (minimal region 80 ish)
...
def run(context):
    ...
    try:
        ...
        export_name = "EUDEMO_complete_test_23"
        export_path = os.path.join(export_folder, export_name)
        step_file = export_path + ".step"
