...
# do the stochastic sampling of eurofer composition for depletion in the WCLL blanket
# for the FS&T paper.
...
for i in range(ns):
  ...
  print("Running simulation " + str(i) + " with seed ", os.getenv('OPENMC_MATERIAL_SEED'))
  ...
  os.system('mkdir -p tokamak/WCLL/eurofer_depletion_run/seed_' + str(seed))
  os.system('cp -r tokamak/WCLL/depletion_results/* tokamak/WCLL/eurofer_depletion_run/seed_' + str(seed))
