...
BLUEMIRA_DIR = PROJECT_ROOT / "detailed_bluemira_hcpb"  # cortex/detailed_bluemira
...
_DAGMC_MODEL_FILE = (BLUEMIRA_DIR / "eudemo_hcpb.h5m")
INPUT_JSON = (BLUEMIRA_DIR / "EUDEMO_HCPB_inputs.json")
...
# Coolant material (dependent on the breeder type) 
...
structure_material_list: list[openmc.Material] = [structural_material, armor_material, ss316] # Basically solid material list
breeder_material_list: list[openmc.Material] = [breeder_material, multiplier_material]
...
MIX_RECIPES_OBJ: dict[str, dict[openmc.Material, float]] = {
    ...
    # FW
    "First_Wall":  {coolant_material: 0.282, structural_material: 0.718},
    # IB
    "ib_layer_1":  {breeder_material: 0.011, multiplier_material: 0.339, coolant_material: 0.567, structural_material: 0.083},
    "ib_layer_2":  {breeder_material: 0.054, multiplier_material: 0.339, coolant_material: 0.528, structural_material: 0.079},
    "ib_layer_3":  {breeder_material: 0.054, multiplier_material: 0.339, coolant_material: 0.530, structural_material: 0.077},
    "ib_layer_4":  {breeder_material: 0.054, multiplier_material: 0.339, coolant_material: 0.530, structural_material: 0.077},
    "ib_layer_5":  {breeder_material: 0.054, multiplier_material: 0.339, coolant_material: 0.530, structural_material: 0.077},
    "ib_layer_6":  {breeder_material: 0.055, multiplier_material: 0.028, coolant_material: 0.643, structural_material: 0.274},
    "ib_layer_7":  {coolant_material: 0.791, structural_material: 0.209},
    "ib_layer_8":  {coolant_material: 0.791, structural_material: 0.209},
    "ib_layer_9":  {coolant_material: 0.04, structural_material: 0.996},
    "ib_layer_10": {coolant_material: 0.04, structural_material: 0.996},    
    # OB
    "ob_layer_1":  {breeder_material: 0.011, multiplier_material: 0.339, coolant_material: 0.567, structural_material: 0.083},
    "ob_layer_2":  {breeder_material: 0.054, multiplier_material: 0.339, coolant_material: 0.528, structural_material: 0.079},
    "ob_layer_3":  {breeder_material: 0.054, multiplier_material: 0.339, coolant_material: 0.530, structural_material: 0.077},
    "ob_layer_4":  {breeder_material: 0.054, multiplier_material: 0.339, coolant_material: 0.530, structural_material: 0.077},
    "ob_layer_5":  {breeder_material: 0.054, multiplier_material: 0.339, coolant_material: 0.530, structural_material: 0.077},
    "ob_layer_6":  {breeder_material: 0.055, multiplier_material: 0.028, coolant_material: 0.643, structural_material: 0.274},
    "ob_layer_7":  {coolant_material: 0.791, structural_material: 0.209},
    "ob_layer_8":  {coolant_material: 0.791, structural_material: 0.209},
    "ob_layer_9":  {coolant_material: 0.04, structural_material: 0.996},
    "ob_layer_10": {coolant_material: 0.04, structural_material: 0.996},
    # Divertor
